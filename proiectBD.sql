#SOURCE C:/Users/gabli/Desktop/BD/Lab1.sql;
...
FOREIGN KEY (id_band) REFERENCES tblBands(id_band);
...
FOREIGN KEY (id_album) REFERENCES tblAlbums(id_album);

/*Songs <-> Categories*/

ALTER TABLE tblSongs
ADD CONSTRAINT fk_song_category
FOREIGN KEY (id_categorie) REFERENCES tblCategories(id_categorie);


/*Composers <-> Songs*/
ALTER TABLE tblComposers
ADD CONSTRAINT fk_composer_song
FOREIGN KEY (id_melodie) REFERENCES tblSongs(id_melodie);
